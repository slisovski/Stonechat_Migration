...
mS <- mergeSites(twl.gl,site=cL$site,distThreshold=500,fixed=fixed,degElevation=90-zenith0)
### considering the measurement errors of our geolocation data: distThreshold =  500km (in this case)
