...
# In this case site site a-m are deployment site
departure <- max(tSecond[cL$site==which(letters[]=="m")])

## departure time is "2014-09-30"
...
mS <- mergeSites(twl.gl,site=cL$site,distThreshold=325,fixed=fixed,degElevation=90-zenith0)
