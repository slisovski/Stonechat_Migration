...
# here, retain the after the blank area (immediately before the battery died)
...
fixed[1:10,] <- cbind(TRUE,TRUE) # the points falling into the vicinity of the breeding site
