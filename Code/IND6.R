...
# In this case site site a-j are deployment site
departure <- max(tSecond[cL$site==which(letters[]=="j")])

## departure time is "2014-10-04"
...
fixed[1:16,] <- cbind(TRUE,TRUE) # the points falling into the vicinity of the breeding site
